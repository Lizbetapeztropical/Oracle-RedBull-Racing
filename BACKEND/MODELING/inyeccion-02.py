# ==================================================================================
# INYECCIÓN RESPALDO: Guardar Notebook 02.ipynb → MongoDB LOCAL (Docker)
# ==================================================================================
...
# ================= CONFIGURATION =================
# Busca el archivo 02.ipynb en la misma carpeta que este script
NOTEBOOK_PATH = Path(__file__).resolve().parent / "02.ipynb"
PKL_PATH = Path(__file__).resolve().parent / "svm_score_model.pkl"
PKL_PATH = Path(__file__).resolve().parent / "xgboost_score_model.pkl"

MONGO_URI = "mongodb://admin:oracle@localhost:27017/"
DATABASE_NAME = "redbull_racing"
COLLECTION_NAME = "02_notebook"
# ==================================================
